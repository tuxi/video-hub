...
class Video(models.Model):
    ...
    likes = GenericRelation(to=Like, verbose_name="likes", related_query_name='videos', content_type_field="receiver_content_type", object_id_field="receiver_object_id")
